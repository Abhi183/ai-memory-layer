...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("ingestion_cost_usd", sa.Float(), nullable=False, server_default="0.0"),
        sa.Column("ingestion_input_tokens", sa.Integer(), nullable=False, server_default="0"),
        sa.Column("ingestion_output_tokens", sa.Integer(), nullable=False, server_default="0"),
